...
def run_inference():
    ...
    # --- CHANGE START: Picamera2 Setup ---
    picam2 = Picamera2()
    
    # Configure camera for video:
    # 1. Main stream size: 640x480 (matches your previous Gstreamer settings)
    # 2. Format: BGR888 (Native OpenCV format, saves processing time)
    ...
    try:
        while True:
            ...
            # capture_array waits for the next frame and returns it as a numpy array
